...
1.1 Release candidates on Staging : X.Y.Z.W (Beta versions, for internal testing only)
...
1.2 Released for customers X.Y.Z : release candidate index W is omitted